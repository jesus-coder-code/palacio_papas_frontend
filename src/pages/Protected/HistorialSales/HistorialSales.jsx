...
import { getSales, deleteSales } from "../../../api";
import { sideBar, user } from "../../../stores";

export function HistorialSales() {
      ...
      const files = data?.data.map((item, i) => {
        return {
          ...
          data: {
            ...
            settings: <Button onClick={() => confirm(item?.id)}>Borrar</Button>,
          },
          children: [
        ...
        <Col sm={12} className="p-0 m-0">
          ...
          >
            ...
            >
              ...
              {userAuth?.role === "Admin" && (
                <Column field="settings" header="Eliminar Venta"></Column>
              )}
            </TreeTable>
          </div>
        </Col>
